...
export class ChatGPTBot {
  ...
  chatgptErrorMessage: string = "ChatGPT met an error.";
  ...
  chatgptSystemContent: string = `You are a chat bot in Wechat, please reply the messages as a friend style.\nKnowledge cutoff: 2021-09-01\nCurrent date: ${this.currentDate}`;
  ...
  private createMessages(text: string): Array<Object> {
    ...
    if (this.messageQueue.length > this.maxLength) {
    ...
    return [this.systemMessage, ...this.messageQueue];
  }
